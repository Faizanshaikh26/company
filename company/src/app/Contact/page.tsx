...
export default function ContactUs() {
  return (
    <div>
        <div className="mt-6 max-w-6xl max-lg:max-w-3xl mx-auto bg-[#222d4f] rounded-lg">
  <div className="grid lg:grid-cols-2 items-center gap-14 sm:p-8 p-4 font-[sans-serif]">
    ...
    <div className="bg-gray-100 p-6 rounded-lg">
      ...
      <div className="space-y-4 max-lg:mt-4">
        <button
          type="button"
          className="px-4 py-2 rounded-lg bg-[#9333ea] text-white text-sm tracking-wider font-medium outline-none border-2 border-[#7e22ce] mr-4"
        >
          Web design
        </button>
        <button
      ...
      <form className="mt-8 space-y-4">
        ...
        <input
          type="email"
          placeholder="Email"
          className="w-full rounded-lg py-3 px-4 text-gray-800 text-sm outline-[#9333ea]"
        />
        <input
          type="text"
          placeholder="Subject"
        ...
        <textarea
          placeholder="Message"
          rows={6}
          className="w-full rounded-lg px-4 text-gray-800 text-sm pt-3 outline-[#9333ea]"
          defaultValue={""}
        />
        <button
          type="button"
          className="text-white bg-[#9333ea] hover:bg-[#7e22ce] tracking-wide rounded-lg text-sm px-4 py-3 flex items-center justify-center w-full !mt-6"
        >
          <svg
            xmlns="http://www.w3.org/2000/svg"
            width="16px"

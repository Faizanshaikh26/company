  ...
  <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
    {opportunities.map((opportunity, index) => (
      ...
      >
        ...
        {/* Title on Image */}
        <div className="absolute bottom-[5px] w-full bg-opacity-50 text-white p-2 transition-opacity duration-500 group-hover:opacity-0">
        ...
        {/* Overlay with Text */}
        <div className="absolute inset-0 bg-[#225ce58c] bg-opacity-90 text-white p-4 transform translate-y-full group-hover:translate-y-0 transition-all duration-500 ease-[cubic-bezier(0.3, 0.7, 0.4, 1)] flex flex-col justify-end">
          <div>
          ...
          >
            ...
            <div
              id="content"
              className="bg-[#f2f8ff] text-[#253053] p-4 h-[50%]"
            >
              <h2 className="font-bold text-lg">One central dashboard</h2>
              <p className="text-sm my-2">
                Hubstaff provides clarity, no matter the industry, by showing
                you:
              </p>
